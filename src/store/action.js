...
export function logout(context) {
    ...
    adminUse.getAjax(context.state.config.groupPath.platformAdmin + "/backLogOut", data).then((resultData) => {
        ...
        if (resultData.resultCode == "000") {
            ...
            adminUse.showToast(resultData.msg + "(" + resultData.resultCode + ")", "red");
        }
    });
}